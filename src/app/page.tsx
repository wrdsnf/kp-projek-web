...
function BranchInfoSection() {
  return (
    <section className="bg-emerald-50/50 py-16 md:py-20 lg:hidden">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-emerald-100">
          <div className="space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-emerald-900 text-sm uppercase tracking-wide mb-1">Alamat</p>
                <p className="text-emerald-700">Jl. Surokarsan No.56, Wirogunan, Kec. Mergangsan, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55151</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-emerald-900 text-sm uppercase tracking-wide mb-1">Jam Operasional</p>
                <div className="space-y-1 text-emerald-700 text-sm">
                  <div className="flex justify-between gap-8">
                    <span>Senin - Jumat</span>
                    <span className="text-amber-600 font-medium">08:00 - 15:00</span>
                  </div>
                  <div className="flex justify-between gap-8">
                    <span>Sabtu</span>
                    <span className="text-amber-600 font-medium">08:00 - 12:00</span>
                  </div>
                  <div className="flex justify-between gap-8">
                    <span>Minggu</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-emerald-900 text-sm uppercase tracking-wide mb-1">Telepon</p>
