    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-md mx-auto px-4 -mt-6">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              status.color === 'green' && "bg-green-100 text-green-700 animate-pulse",
          ...
          <div className="p-4 border-t border-gray-100 flex justify-center">
            <span className={cn(
              ...
              data?.status === 'open' ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
            )}>
        ...
        <div className="mt-6 text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">
            <Link href="/queue" className="text-green-600 hover:underline">
              Ambil antrian baru →
            </Link>
          </p>
        </div>
