      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="text-center py-6 px-4 bg-emerald-50 hover:bg-emerald-50 rounded-xl transition-colors border border-emerald-100">
                <item.icon className="w-8 h-8 text-emerald-600 mx-auto mb-2" />
                <p className="font-semibold text-emerald-800 text-sm">{item.label}</p>
                <p className="text-emerald-600 text-xs mt-1">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Kirim Uang */}
            <div className="border border-emerald-200 rounded-xl p-6 hover:border-emerald-300 transition-colors">
