      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 py-16 md:py-24">
            <Link href="/" className="inline-flex items-center gap-2 text-gray-500 hover:text-purple-700 transition-colors mb-8 text-sm">
              <ArrowLeft className="w-4 h-4" />
              Kembali ke Beranda
            </Link>

            <div className="flex items-start gap-6">
              <div className="hidden md:flex w-20 h-20 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl items-center justify-center shadow-lg flex-shrink-0">
        ...
        <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="text-center py-6 px-4 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors">
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4 py-4 px-6 bg-gradient-to-r from-purple-50 to-transparent border-l-4 border-purple-500 rounded-r-lg">
        ...
        {/* CTA */}
        <section className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/queue"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-purple-700 font-bold py-4 px-8 rounded-xl transition-colors shadow-lg"
              >
