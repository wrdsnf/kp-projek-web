    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
          ...
          <p className="text-emerald-700 leading-relaxed mb-10">
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-emerald-500 pl-6 py-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-emerald-900">KREASI</h3>
              </div>
            ...
            <div className="border-l-4 border-emerald-500 pl-6 py-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-emerald-900">KRASIDA</h3>
              </div>
              <p className="text-emerald-700 mb-3">
            ...
            <div className="border-l-4 border-emerald-500 pl-6 py-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-emerald-900">AMANAH</h3>
              </div>
              <p className="text-emerald-700 mb-3">
            ...
            <div className="border-l-4 border-emerald-500 pl-6 py-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-emerald-900">Rahn (Gadai Syariah)</h3>
              </div>
              <p className="text-emerald-700 mb-3">
